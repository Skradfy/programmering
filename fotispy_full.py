...
class Song:
    ...
    def __str__(self):
        return f"Title: {self.title}, Artist: {self.artist}, Længde: {self.length}"
...
class Playlist:
    ...
    def add_song(self, song):
        ...
        print(f"Tilføjede {song.title} til listen.")
    ...
    def shuffle(self):
        ...
        print("Listen er blevet shufflet. Afspiller nu:")
...
class Menu:
    ...
    def choose_song(self):
        ...
        if choice == '1':
            ...
            print("Kan ikke lade sig gøre, prøv igen.")
            return None
